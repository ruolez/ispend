...
BANK_CASES = [
    ...
    ("pnc_checking.csv", "pnc", 5, (date(2024, 8, 12), Decimal("-100.00"), "ATM WITHDRAWAL PNC BANK ATM 5TH AVE PITTSBURGH PA"),
     (date(2024, 8, 2), Decimal("2500.00"), "DIRECT DEPOSIT ACME CORP PAYROLL")),
    ("pnc_classic.csv", "pnc", 3, (date(2024, 8, 12), Decimal("-100.00"), "ATM WITHDRAWAL PNC BANK ATM 5TH AVE PITTSBURGH PA"),
     (date(2024, 8, 2), Decimal("2500.00"), "DIRECT DEPOSIT ACME CORP PAYROLL")),
    ("pnc_activity.csv", "pnc", 3, (date(2024, 8, 12), Decimal("-100.00"), "ATM WITHDRAWAL PNC BANK ATM 5TH AVE PITTSBURGH PA"),
     (date(2024, 8, 2), Decimal("2500.00"), "DIRECT DEPOSIT ACME CORP PAYROLL")),
