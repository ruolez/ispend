...
function renderRecurring() {
  ...
  host.innerHTML = `<div class="tbl-wrap" style="border:0;box-shadow:none;border-radius:0"><table class="tbl rec-table"><thead><tr><th>Merchant</th><th>Category</th><th class="col-cadence">Cadence</th><th class="right">Amount</th><th class="col-last">Last</th><th class="right">Next</th><th class="col-actions"><span class="sr-only">Actions</span></th></tr></thead><tbody>
