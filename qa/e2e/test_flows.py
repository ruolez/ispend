...
def test_f5_review(page, qapi):
    ...
    F.check("1 skipped" in page.locator("#rv-progress").inner_text(), f"progress shows skipped count: {page.locator('#rv-progress').inner_text()!r}")
...
def test_f10_settings(page, qapi, browser):
    ...
    page.click("#me-pw-form button[type=submit]")
    t = toast(page, "do not match")
    F.check("do not match" in t, "mismatch feedback")
    page.fill("#me-new", "newpass123")
    page.fill("#me-conf", "newpass123")
    page.click("#me-pw-form button[type=submit]")
